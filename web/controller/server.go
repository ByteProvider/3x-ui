...
// @Produce      json
// @Security     ApiKeyAuth
// @Param        fileName  path      string  false  "Geo file name (optional)"
// @Success      200       {object}  entity.Msg
// @Failure      400       {object}  entity.Msg
// @Router       /server/updateGeofile [post]
...
// @Produce      json
// @Security     ApiKeyAuth
// @Param        count   path      string  true   "Number of log lines to retrieve"
...
// @Security     ApiKeyAuth
// @Param        count       path      string  true   "Number of log lines to retrieve"
// @Param        filter      formData  string  false  "Search filter"
...
// @Produce      json
// @Security     ApiKeyAuth
// @Param        db   formData  file  true  "Database file to import"
// @Success      200  {object}  entity.Msg
// @Failure      400  {object}  entity.Msg
